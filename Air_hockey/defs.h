...
const int SETTING_MENU_TEXT_Y = 550;
const int SETTING_MENU_TEXT_X = SOUND_X + 25;
const int SETTING_MENU_X = SOUND_X;
const int SETTING_MENU_Y = SETTING_MENU_TEXT_Y - 25;
const int SETTING_DIFF_Y = SETTING_MENU_TEXT_Y+ 100;
const int SETTING_DIFF_TEXT_Y = SETTING_DIFF_Y + 25;
const int MUSIC_VOLUME_X = 350;
const int SOUND_VOLUME_X = 350;
const int MENU_BUTTON_SIZE = 450;
const int MENU_BUTTON_SIZE_Y = 183;
const int SETTING_BUTTON_SIZE = MENU_BUTTON_SIZE/2;
const int SETTING_BUTTON_SIZE_Y = MENU_BUTTON_SIZE_Y/2;
...
const double EASY_SPEED = NORMAL_SPEED/5.0*3;
const double BAT_RADIUS = 25;
const double DISK_RADIUS = 20;
const double MAX_DISK_SPEED = 12;
